...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_testFunc')) {
        Object.defineProperty(Module['ready'], '_testFunc', { configurable: true, get: function() { abort('You are getting _testFunc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_testFunc', { configurable: true, set: function() { abort('You are setting _testFunc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile = 'wasm_module.wasm';
